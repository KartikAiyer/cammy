...
set(tools ${CMAKE_CURRENT_LIST_DIR}/../toolchain/cross-pi-gcc-10.2.0-64) # warning change toolchain path here.
set(rootfs_dir ${CMAKE_CURRENT_LIST_DIR}/../toolchain/rootfs)
...
set(ENV{PKG_CONFIG_PATH} "${CMAKE_SYSROOT}/usr/lib/${CMAKE_LIBRARY_ARCHITECTURE}/pkgconfig")
# set(ENV{PKG_CONFIG_LIBDIR} "${CMAKE_SYSROOT}/usr/lib/pkgconfig:${CMAKE_SYSROOT}/usr/lib/${CMAKE_LIBRARY_ARCHITECTURE}")
